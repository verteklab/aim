...
const routes: { [key: string]: any } = {
  ...
  METRICS: {
    ...
    component: Metrics,
    showInSidebar: true,
    displayName: 'navigation.metrics',
    icon: 'metrics',
    isExact: true,
  ...
  FIGURES_EXPLORER: {
    ...
    showInSidebar: true,
    icon: 'figures',
    displayName: 'navigation.figures',
    isExact: true,
  ...
  SCATTERS: {
    ...
    component: Scatters,
    showInSidebar: true,
    displayName: 'navigation.scatters',
    icon: 'scatterplot',
    isExact: true,
  ...
  BOOKMARKS: {
    ...
    component: Bookmarks,
    showInSidebar: true,
    displayName: 'navigation.bookmarks',
    icon: 'bookmarks',
    isExact: true,
  ...
  RUN_DETAIL: {
    ...
    component: RunDetail,
    showInSidebar: false,
    displayName: pageTitlesEnum.RUN_DETAIL,
    isExact: false,
  ...
  Experiment: {
    ...
    showInSidebar: false,
    displayName: pageTitlesEnum.EXPERIMENT,
    isExact: false,
  ...
  METRICS_EXPLORER: {
    ...
    showInSidebar: false,
    icon: 'metrics',
    displayName: pageTitlesEnum.METRICS_EXPLORER_V2,
    isExact: true,
  ...
  REPORT: {
    ...
    component: Report,
    showInSidebar: false,
    displayName: pageTitlesEnum.REPORT,
    isExact: true,
